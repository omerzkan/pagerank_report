...
Part~I is Homework~1: we describe the PageRank algorithm and when it does not work, we present our own implementation (a hand-written sparse matrix and the power method), we test it on the two small webs of the paper and on the Hollins dataset (6012 pages), and we solve Exercises~11 and~17.
...
\input{sec/hw1_intro}
\input{sec/hw1_algorithm}
\input{sec/hw1_implementation}
\input{sec/ex11}
\input{sec/ex17}
